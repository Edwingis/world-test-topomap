...
var format_WB_Land_10m_1 = new ol.format.GeoJSON();
var features_WB_Land_10m_1 = format_WB_Land_10m_1.readFeatures(json_WB_Land_10m_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_WB_Land_10m_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_WB_Land_10m_1.addFeatures(features_WB_Land_10m_1);
var lyr_WB_Land_10m_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_WB_Land_10m_1, 
                style: style_WB_Land_10m_1,
                interactive: true,
                title: '<img src="styles/legend/WB_Land_10m_1.png" /> WB_Land_10m'
            });
var format_WB_countries_Admin0_10m_2 = new ol.format.GeoJSON();
var features_WB_countries_Admin0_10m_2 = format_WB_countries_Admin0_10m_2.readFeatures(json_WB_countries_Admin0_10m_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_WB_countries_Admin0_10m_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_WB_countries_Admin0_10m_2.addFeatures(features_WB_countries_Admin0_10m_2);
var lyr_WB_countries_Admin0_10m_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_WB_countries_Admin0_10m_2, 
                style: style_WB_countries_Admin0_10m_2,
                interactive: true,
                title: '<img src="styles/legend/WB_countries_Admin0_10m_2.png" /> WB_countries_Admin0_10m'
            });

lyr_GoogleTerrain_0.setVisible(true);lyr_WB_Land_10m_1.setVisible(true);lyr_WB_countries_Admin0_10m_2.setVisible(true);
var layersList = [lyr_GoogleTerrain_0,lyr_WB_Land_10m_1,lyr_WB_countries_Admin0_10m_2];
lyr_WB_Land_10m_1.set('fieldAliases', {'featurecla': 'featurecla', });
lyr_WB_countries_Admin0_10m_2.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'featurecla': 'featurecla', 'LEVEL': 'LEVEL', 'TYPE': 'TYPE', 'FORMAL_EN': 'FORMAL_EN', 'FORMAL_FR': 'FORMAL_FR', 'POP_EST': 'POP_EST', 'POP_RANK': 'POP_RANK', 'GDP_MD_EST': 'GDP_MD_EST', 'POP_YEAR': 'POP_YEAR', 'LASTCENSUS': 'LASTCENSUS', 'GDP_YEAR': 'GDP_YEAR', 'ECONOMY': 'ECONOMY', 'INCOME_GRP': 'INCOME_GRP', 'FIPS_10_': 'FIPS_10_', 'ISO_A2': 'ISO_A2', 'ISO_A3': 'ISO_A3', 'ISO_A3_EH': 'ISO_A3_EH', 'ISO_N3': 'ISO_N3', 'UN_A3': 'UN_A3', 'WB_A2': 'WB_A2', 'WB_A3': 'WB_A3', 'CONTINENT': 'CONTINENT', 'REGION_UN': 'REGION_UN', 'SUBREGION': 'SUBREGION', 'REGION_WB': 'REGION_WB', 'NAME_AR': 'NAME_AR', 'NAME_BN': 'NAME_BN', 'NAME_DE': 'NAME_DE', 'NAME_EN': 'NAME_EN', 'NAME_ES': 'NAME_ES', 'NAME_FR': 'NAME_FR', 'NAME_EL': 'NAME_EL', 'NAME_HI': 'NAME_HI', 'NAME_HU': 'NAME_HU', 'NAME_ID': 'NAME_ID', 'NAME_IT': 'NAME_IT', 'NAME_JA': 'NAME_JA', 'NAME_KO': 'NAME_KO', 'NAME_NL': 'NAME_NL', 'NAME_PL': 'NAME_PL', 'NAME_PT': 'NAME_PT', 'NAME_RU': 'NAME_RU', 'NAME_SV': 'NAME_SV', 'NAME_TR': 'NAME_TR', 'NAME_VI': 'NAME_VI', 'NAME_ZH': 'NAME_ZH', 'WB_NAME': 'WB_NAME', 'WB_RULES': 'WB_RULES', 'WB_REGION': 'WB_REGION', 'Shape_Leng': 'Shape_Leng', 'Shape_Area': 'Shape_Area', });
lyr_WB_Land_10m_1.set('fieldImages', {'featurecla': 'TextEdit', });
...
lyr_WB_Land_10m_1.set('fieldLabels', {'featurecla': 'no label', });
...
lyr_WB_countries_Admin0_10m_2.on('precompose', function(evt) {
